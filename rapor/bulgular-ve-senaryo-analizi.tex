...
\subsection{Darboğaz Sınaması} \label{sec:darboğaz-sınaması}
    ...
    Analizi yapılan senaryolar ardından sistem \autoref{sec:stres-sınaması}'teki tek görevli senaryo baz alınarak farklı araç sayılarındaki hesaplama performansı test edilmiştir.
